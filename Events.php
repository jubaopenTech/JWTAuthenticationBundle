...
final class Events
{
     ...
     */
    const AUTHENTICATION_SUCCESS = 'jbp_jwt_authentication.on_authentication_success';

    /**
     * Dispatched after an authentication failure.
     * Hook into this event to add a custom error message in the response body.
     */
    const AUTHENTICATION_FAILURE = 'jbp_jwt_authentication.on_authentication_failure';
     ...
     */
    const JWT_CREATED = 'jbp_jwt_authentication.on_jwt_created';

    /**
     * Dispatched right after token string is created.
     * Hook into this event to get token representation itself.
     */
    const JWT_ENCODED = 'jbp_jwt_authentication.on_jwt_encoded';
     ...
     */
    const JWT_DECODED = 'jbp_jwt_authentication.on_jwt_decoded';
     ...
     */
    const JWT_AUTHENTICATED = 'jbp_jwt_authentication.on_jwt_authenticated';

    /**
     * Dispatched after the token has been invalidated by the provider.
     * Hook into this event to add a custom error message in the response body.
     */
    const JWT_INVALID = 'jbp_jwt_authentication.on_jwt_invalid';

    /**
     * Dispatched when no token can be found in a request.
     * Hook into this event to set a custom response.
     */
    const JWT_NOT_FOUND = 'jbp_jwt_authentication.on_jwt_not_found';
     ...
     * response.
     */
    const JWT_EXPIRED = 'jbp_jwt_authentication.on_jwt_expired';
}
