...
/**
 * JbpJWTAuthenticationBundle Configuration.
 */
class Configuration implements ConfigurationInterface
{
    ...
    public function getConfigTreeBuilder()
    {
        ...
        $rootNode    = $treeBuilder->root('jbp_jwt_authentication');
        ...
        $rootNode
            ...
            ->children()
                ...
                ->arrayNode('encoder')
                    ...
                    ->children()
                        ->scalarNode('service')
                            ->defaultValue('jbp_jwt_authentication.encoder.default')
                        ->end()
